...
func InitApp() (*server.App, func(), error) {
	...
	commentService := ProvideCommentService(logger, commentRepo, fileService)
	commentHandler := ProvideCommentHandler(commentService)
	v := ProvideHandlers(userHandler, healthHandler, fileHandler, systemHandler, momentHandler, anniversaryHandler, placeHandler, albumHandler, commentHandler)
