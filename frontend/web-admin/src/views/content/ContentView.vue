...
const tabs = ref([
  { name: "moments", label: "动态", path: "/content/moments", icon: "moment" },
  {
    name: "anniversaries",
    label: "纪念日",
    path: "/content/anniversaries",
    icon: "anniversary",
  },
  { name: "places", label: "足迹", path: "/content/places", icon: "place" },
  { name: "albums", label: "相册", path: "/content/albums", icon: "camera" },
]);
