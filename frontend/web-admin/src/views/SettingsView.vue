  ...
  <div class="flex flex-col pb-10">
    ...
    <div class="admin-card overflow-hidden mb-8">
      <div class="px-6 py-4 border-b border-black/5 bg-black/5">
        <h3
          class="text-sm font-bold admin-text-secondary uppercase tracking-wider"
        >
          系统信息
        </h3>
      </div>
      <div class="divide-y divide-black/5">
        <div
          class="px-6 py-4 flex justify-between items-center hover:bg-black/5 transition-colors"
        >
          <span class="text-sm font-medium admin-text-primary">系统版本</span>
          <span
            class="text-sm font-bold admin-text-secondary bg-white/50 px-2 py-0.5 rounded-md"
            >1.0.0</span
          >
        </div>
        <div
        ...
        >
          ...
          <span
            class="text-sm font-bold text-green-600 bg-green-50 px-2 py-0.5 rounded-md"
            >生产环境</span
          >
        </div>
      </div>
    ...
    <div class="admin-card overflow-hidden">
      <div
        class="px-6 py-4 border-b border-black/5 bg-black/5 flex justify-between items-center"
      >
        <div>
          <h3
            class="text-sm font-bold admin-text-secondary uppercase tracking-wider"
      ...
      <form class="p-6 space-y-6">
        <div class="space-y-2">
          <label
            for="site-title"
            class="block text-sm font-bold admin-text-primary px-1"
          >
        ...
        <div class="pt-6 border-t border-black/5 flex gap-4">
          <button
            type="button"
            @click="resetForm"
            class="admin-btn-secondary flex-1 py-3"
          >
            重置
          </button>
          <button
