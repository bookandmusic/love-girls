<template>
  <div class="flex justify-center py-4 flex-shrink-0 w-full">
    <div
      class="glass-thick rounded-full p-1 flex items-center border border-white/40 shadow-sm"
    >
      <button
        @click="onPrev"
      ...
      <div
        class="px-4 py-1 flex items-center text-sm font-semibold text-[var(--fe-text-primary)]"
      >
